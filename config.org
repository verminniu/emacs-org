...
#+BEGIN_SRC emacs-lisp :tangle yes
  (use-package cquery
    ...
    (cquery-extra-args '("--log-file=~/.cquery/log/cq.log"))
    (cquery-cache-dir "~/.cquery/cache")
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (use-package ispell
    :defer 2
    :ensure-system-package (hunspell . "brew install hunspell")
    :custom
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (use-package ledger-mode
    :ensure-system-package (ledger . "brew install ledger")
    :mode ("\\.dat\\'"
           "\\.ledger\\'")
