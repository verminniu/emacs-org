...
#+begin_src emacs-lisp :tangle yes
  (use-package elfeed
    ...
    (setq elfeed-db-directory (expand-file-name "elfeed/db" user-emacs-directory)
          ...
          elfeed-search-title-max-width 85)
    ...
    (define-key elfeed-search-mode-map (kbd "v a") (lambda () (interactive) (elfeed-search-set-filter "@6-months-ago +unread")))
    (define-key elfeed-search-mode-map (kbd "v e") (lambda () (interactive) (elfeed-search-set-filter "+emacs +unread")))
    (define-key elfeed-search-mode-map (kbd "v b") (lambda () (interactive) (elfeed-search-set-filter "+blogs +unread"))))
#+end_src
